...
class Run(threading.Thread):
    def __init__(self,node_num = 100,network_type = "RG",update_rule ="EF",player_type = "C",
        avg_degree = 4,intensity_selection = 0.01,mutate_rate = 0.001,check_point = None,Epochs = 10000000):
        super().__init__()
...
if __name__ == '__main__':
    p1=Run(node_num = 100,network_type = "RG",update_rule ="EF",player_type = "C",
            avg_degree = 4,intensity_selection = 0.01,mutate_rate = 0.1,check_point = None)
    p2=Run(node_num = 100,network_type = "RG",update_rule ="EF",player_type = "C",
            avg_degree = 4,intensity_selection =0.1,mutate_rate = 0.1,check_point = None)

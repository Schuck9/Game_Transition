...
def transition_viz(data_path):
    ...
    for i,u in enumerate(u_):
	    ...
	    plt.plot(x_axis, y_p_list[i] ,marker='^',linestyle='-',color='skyblue', label='Share = 0.5/1')
	    plt.plot(x_axis, y_p_list[i+1], marker='s',linestyle='-',color='green', label='Share = 1')
	    plt.plot(x_axis, y_p_list[i+2], marker='*',linestyle='-',color='red', label='Share = 0.5')
	    ...
	    # plt.plot(x_axis, q_axis, marker='s',linestyle='-',color='red', label='Demand (q)')
        # plt.plot(x_axis, y_list[0] ,marker='>',linestyle='-',color='purple', label='w = 0.001')
	    plt.plot(x_axis, y_q_list[i] ,marker='^',linestyle='-',color='skyblue', label='Share = 0.5/1')
	    plt.plot(x_axis, y_q_list[i+1], marker='s',linestyle='-',color='green', label='Share = 1')
